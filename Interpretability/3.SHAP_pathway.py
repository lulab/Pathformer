...
ckpt = torch.load('/qhsky1/liuxiaofan_result/model_TCGA_new/BRCA_subtype/7.CCnet_new/1/final/ckpt/BRCA_61.pth',map_location='cuda:0')
...
# N_SAMPLES=1
# shap= explainer.shap_values(background, nsamples=N_SAMPLES)

N_SAMPLES=1
shap_1 = h5py.File(save_path+'/shap_pathway_1.h5', 'a')
shap_2 = h5py.File(save_path+'/shap_pathway_2.h5', 'a')
shap_3 = h5py.File(save_path+'/shap_pathway_3.h5', 'a')
shap_4 = h5py.File(save_path+'/shap_pathway_4.h5', 'a')
shap_5 = h5py.File(save_path+'/shap_pathway_5.h5', 'a')
y_val = []
