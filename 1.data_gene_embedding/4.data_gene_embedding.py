...
def data_filter(raw_data_path,embedding_data_path,sample_id_path,save_path,cancer):
    # RNA
    print('RNA')
    data_mRNA=pd.read_csv(raw_data_path+cancer+'.mRNA.csv',sep=',')
    ...
    data_miRNA=pd.read_csv(raw_data_path+cancer+'.miRNA.csv',sep=',')
    ...
    id_data=pd.read_csv('/apps/home/lulab_liuxiaofan/qhsky/project/multi_omics_paper/reference/miRNA_id_new.txt',sep='\t')
    ...
    length_data=pd.read_csv('/apps/home/lulab_liuxiaofan/qhsky/project/multi_omics_paper/reference/gene.length.new.txt',sep='\t',header=None)
    ...
    data_methylation=pd.read_csv(raw_data_path+cancer+'.DNAmethy.csv',sep=',')
    ...
    data_CNV=pd.read_csv(embedding_data_path+cancer+'.CNV_masked_seg.all.csv',sep='\t')
    ...
    data_CNV=pd.read_csv(embedding_data_path+'/all_data_by_genes.txt',sep='\t')
    ...
    gtf_data=pd.read_csv('/apps/home/lulab_liuxiaofan/qhsky/project/multi_omics_paper/reference/gtf_name_103.txt',sep='\t')
...
def main(args):
    ...
    data_filter(args.raw_data_path, args.embedding_data_path,args.sample_id_path ,args.save_path, args.cancer)
