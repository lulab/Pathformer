...
class EvoformerBlock_2(nn.Module):
    def __init__(
        ...
        self.layer = nn.ModuleList([
            AxialAttention_2(dim=row_dim, heads=heads, dim_head=dim_head, dropout=attn_dropout, row_attn=True,col_attn=False, accept_edges=False, norm_tf=norm_tf),
    ...
    def forward(self, inputs, output_attentions=False):
        ...
        if output_attentions:
            return x, m,mask, msa_mask, attn_out_row_1, attn_out_row_2, attn_out_col_1, attn_out_col_2
        else:
