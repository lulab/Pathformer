...
def get_shap_sample(modal_all_path, modal_select_path, gene_all, gene_select, pathway_gene_w,pathway_crosstalk_network,
    ...
    N_SAMPLES=1
    shap_all = h5py.File(save_path+'/shap_gene_all.h5', 'a')
    ...
    np.save(file=save_path + '/data_label_SHAP.npy', arr=np.array(y_all))
    shap_all.close()

def main(args):
    get_shap_sample(args.modal_all_path, args.modal_select_path, args.gene_all, args.gene_select, args.pathway_gene_w,args.pathway_crosstalk_network,
