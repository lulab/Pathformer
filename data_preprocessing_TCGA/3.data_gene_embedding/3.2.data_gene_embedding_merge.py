...
def get_data(path,reference_path,label_path,save_path):
    ...
    feature_type=pd.read_csv(reference_path+'/feature_type.txt',sep='\t',header=None)
...
def main(args):
    get_data(args.path, args.reference_path, args.label_path, args.save_path, feature_data)
