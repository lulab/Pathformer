...
--path_label /apps/home/lulab_liuxiaofan/qhsky/project/multi_omics_paper/data/data_gene_embedding/sample_id/sample_cross_subtype.txt \\
--savepath /apps/home/lulab_liuxiaofan/qhsky/project/multi_omics_paper/data/data_preprocessing/1.diff_feature_subtype/${num}/ \\
--dataset ${num} \\
--scaler 1 \\
--feature_type ${i}
">/apps/home/lulab_liuxiaofan/qhsky/project/multi_omics_paper/2.data_preprocessing/log/${i}_feature_filter_ANOVA_subtype_${num}.sh
done
done
done