...
python3 /apps/home/lulab_liuxiaofan/qhsky/project/multi_omics_paper/2.data_preprocessing/1.2.feature_filter_ANOVA.py \\
--feature_path /apps/home/lulab_liuxiaofan/qhsky/project/multi_omics_paper/data/data_gene_embedding/embedding/${i}.txt \\
--path_label /apps/home/lulab_liuxiaofan/qhsky/project/multi_omics_paper/data/data_gene_embedding/sample_id/sample_cross_survival.txt \\
--savepath /apps/home/lulab_liuxiaofan/qhsky/project/multi_omics_paper/data/data_preprocessing/1.diff_feature_survival/${num}/ \\
--dataset ${num} \\
--scaler 1 \\
--feature_type ${i}
">/apps/home/lulab_liuxiaofan/qhsky/project/multi_omics_paper/2.data_preprocessing/log/${i}_feature_filter_ANOVA_survival_${num}.sh
done
done
done