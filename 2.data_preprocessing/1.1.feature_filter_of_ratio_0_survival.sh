...
--path_label /apps/home/lulab_liuxiaofan/qhsky/project/multi_omics_data/TCGA_new/${c}/sample_id/sample_cross_survival.txt \\
--savepath /apps/home/lulab_liuxiaofan/qhsky/project/multi_omics_paper/data/data_preprocessing/1.diff_feature_survival/${num}/ \\
--dataset ${num} \\
--p 0.1 \\
--feature_type ${i}
">/apps/home/lulab_liuxiaofan/qhsky/project/multi_omics_paper/2.data_preprocessing/log/${i}_feature_filter_of_ratio_0_survival_${num}.sh
done
done
done