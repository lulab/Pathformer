...
--path_label /apps/home/lulab_liuxiaofan/qhsky/project/multi_omics_paper/data/data_gene_embedding/sample_id/sample_cross_stage.txt \\
--savepath /apps/home/lulab_liuxiaofan/qhsky/project/multi_omics_paper/data/data_preprocessing/1.diff_feature_stage/${num}/ \\
--dataset ${num} \\
--scaler 1 \\
--feature_type ${i}
">/apps/home/lulab_liuxiaofan/qhsky/project/multi_omics_paper/2.data_preprocessing/log/${i}_feature_filter_ANOVA_stage_${num}.sh
done
done
done