...
--savepath ${root_path}/data_TCGA/4.data_feature_filter_of_comparison_methods/1.diff_feature_stage/1/ \
--dataset 1 \
--p 0.1 \
--feature_type ${i}
done
...
--savepath ${root_path}/data_TCGA/4.data_feature_filter_of_comparison_methods/1.diff_feature_survival/1/ \
--dataset 1 \
--p 0.1 \
--feature_type ${i}
done
...
python3 ${root_path}/comparison_methods/data_feature_filter/1.1.feature_filter_of_ratio_0.py \
--feature_path ${root_path}/data_TCGA/3.data_gene_embedding/embedding_all/${i}.txt \
--path_label ${root_path}/data_TCGA/2.sample_id/sample_cross_subtype.txt \
--savepath ${root_path}/data_TCGA/4.data_feature_filter_of_comparison_methods/1.diff_feature_subtype/1/ \
--dataset 1 \
--p 0.1 \
--feature_type ${i}
done
...
--feature_path ${root_path}/data_TCGA/4.data_feature_filter_of_comparison_methods/1.diff_feature_stage/1/ \
--feature_num_type ANOVA_1000 \
--save_path ${root_path}/data_TCGA/4.data_feature_filter_of_comparison_methods/2.data_feature_stage/1

python3 ${root_path}/comparison_methods/data_feature_filter/2.1.data_filter.py \
--path ${root_path}/data_TCGA/3.data_gene_embedding/embedding_all/ \
--label_path ${root_path}/data_TCGA/2.sample_id/sample_cross_survival.txt \
--feature_path ${root_path}/data_TCGA/4.data_feature_filter_of_comparison_methods/1.diff_feature_survival/1/ \
--feature_num_type ANOVA_1000 \
--save_path ${root_path}/data_TCGA/4.data_feature_filter_of_comparison_methods/2.data_feature_survival/1

python3 ${root_path}/comparison_methods/data_feature_filter/2.1.data_filter.py \
--path ${root_path}/data_TCGA/3.data_gene_embedding/embedding_all/ \
--label_path ${root_path}/data_TCGA/2.sample_id/sample_cross_subtype.txt \
--feature_path ${root_path}/data_TCGA/4.data_feature_filter_of_comparison_methods/1.diff_feature_subtype/1/ \
--feature_num_type ANOVA_1000 \
--save_path ${root_path}/data_TCGA/4.data_feature_filter_of_comparison_methods/2.data_feature_subtype/1
...
--label_path ${root_path}/data_TCGA/2.sample_id/sample_cross_subtype.txt \
--reference_path ${root_path}/reference/ \
--save_path ${root_path}/data_TCGA/4.data_feature_filter_of_comparison_methods/3.merge_all_subtype/
