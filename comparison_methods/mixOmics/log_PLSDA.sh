...
1 \
${root_path}/comparison_methods/Result/BRCA_stage/mixOmics/PLSDA/1/merge/
...
1 \
${root_path}/comparison_methods/Result/BRCA_survival/mixOmics/PLSDA/1/merge/
...
1 \
${root_path}/comparison_methods/Result/BRCA_subtype/mixOmics/PLSDA/1/merge/

python3 ${root_path}/comparison_methods/mixOmics/result_PLSDA.py \
--result_path ${root_path}/comparison_methods/Result/BRCA_subtype/mixOmics/PLSDA/1/merge/
