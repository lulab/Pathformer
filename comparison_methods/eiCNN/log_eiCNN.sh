...
mkdir ${root_path}/comparison_methods/Result/BRCA_stage/eicNN
cd ${root_path}/comparison_methods/eicNN
python3 ${root_path}/comparison_methods/eicNN/1.model.py \
...
--delta 1-e2 \
--stop_epoch 200 \
--save_path ${root_path}/comparison_methods/Result/BRCA_stage/eicNN/


mkdir ${root_path}/comparison_methods/Result/BRCA_survival/eicNN
cd ${root_path}/comparison_methods/eicNN
python3 ${root_path}/comparison_methods/eicNN/1.model.py \
...
--delta 1-e2 \
--stop_epoch 200 \
--save_path ${root_path}/comparison_methods/Result/BRCA_survival/eicNN/
