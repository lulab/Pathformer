...
def main_model(label_path, data_path, dataset, model_name, save_path, epoch_num, learning_rate,stop):
    ...
    train_sample = list(label.loc[label['dataset_' + str(dataset)+'_test'] == 'train', 'sample_id'])
    test_sample = list(label.loc[label['dataset_' + str(dataset)+'_test'] == 'test', 'sample_id'])
    ...
    data_count_train=pd.read_csv(data_path+str(dataset)+'/data_count_train_all.txt',sep='\t')
    data_count_train=data_count_train[train_sample]
    data_count_test=pd.read_csv(data_path+str(dataset)+'/data_count_test_all.txt',sep='\t')
    data_count_test=data_count_test[test_sample]
    data_count_validation=pd.read_csv(data_path+str(dataset)+'/data_count_validation_all.txt',sep='\t')
    data_count_validation=data_count_validation[validation_sample]
    data_methylation_train=pd.read_csv(data_path+str(dataset)+'/data_methylation_train_all.txt',sep='\t')
    data_methylation_train=data_methylation_train[train_sample]
    data_methylation_test=pd.read_csv(data_path+str(dataset)+'/data_methylation_test_all.txt',sep='\t')
    data_methylation_test=data_methylation_test[test_sample]
    data_methylation_validation=pd.read_csv(data_path+str(dataset)+'/data_methylation_validation_all.txt',sep='\t')
    data_methylation_validation=data_methylation_validation[validation_sample]
    data_CNV_train=pd.read_csv(data_path+str(dataset)+'/data_CNV_train_all.txt',sep='\t')
    data_CNV_train=data_CNV_train[train_sample]
    data_CNV_test=pd.read_csv(data_path+str(dataset)+'/data_CNV_test_all.txt',sep='\t')
    data_CNV_test=data_CNV_test[test_sample]
    data_CNV_validation=pd.read_csv(data_path+str(dataset)+'/data_CNV_validation_all.txt',sep='\t')
