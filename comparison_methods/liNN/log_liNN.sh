...
mkdir ${root_path}/comparison_methods/Result/BRCA_stage/liNN
cd ${root_path}/comparison_methods/liNN
python3 ${root_path}/comparison_methods/liNN/1.model.py \
...
--delta 1-e2 \
--stop_epoch 200 \
--save_path ${root_path}/comparison_methods/Result/BRCA_stage/liNN/


mkdir ${root_path}/comparison_methods/Result/BRCA_survival/liNN
cd ${root_path}/comparison_methods/liNN
python3 ${root_path}/comparison_methods/liNN/1.model.py \
...
--delta 1-e2 \
--stop_epoch 200 \
--save_path ${root_path}/comparison_methods/Result/BRCA_survival/liNN/
